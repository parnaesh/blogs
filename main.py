...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://blogs:parna@localhost:8889/blogs'
app.config['SQLALCHEMY_ECHO'] = True
db = SQLAlchemy(app)
app.secret_key = 'ncaksjco'
...
def home():
    ...
    return render_template('home.html', title= "blog users", 
